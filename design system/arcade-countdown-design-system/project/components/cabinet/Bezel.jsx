...
export function Bezel({ interactive = false, lit = false, ratio = '3/4', children, footer, style, ...rest }) {
  ...
  return (
    <div
      ...
      style={{
        position: 'relative', background: 'var(--surface-chassis)', border: '1px solid var(--hairline)',
      ...
      {...rest}
    >
      <div style={{ position: 'relative', aspectRatio: ratio, background: 'var(--surface-screen)', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', boxShadow: lit ? 'var(--mat-screen-on)' : 'var(--mat-screen)' }}>
        {children}
